...
-- @Last Modified time  : 2024-10-26 18:13:42
...
function 法术:法术取描述(攻击方, 挨打方)
    return string.format("有几率无需召唤自动加入战斗，提高冰混遗忘抗性#r#R%s%%,#r#G回合开始时如果自身血量低于30%%，有%s%%几率自我恢复50%%血量",self:取效果(攻击方),self:取几率(攻击方, 挨打方))
end
