...
function 角色创建:初始化()
    ...
    self:置精灵(__res:getspr('gires/0xD4FFCC2E4.tcp'))
    self.选中框 = __res:getspr('gires2/login/selectrole.tca'):置拉伸(54, 71)
    self.选中坐标 = { x = 18, y = 64 }
    self.选中 = 1
...
--===============================================================================================
for i, v in ipairs {
    { 路径 = '1.tga', 外形 = 1, 外形1 = 18, x = 18, y = 64 },
    { 路径 = '2.tga', 外形 = 2, 外形1 = 18, x = 18, y = 148 },
    { 路径 = '3.tga', 外形 = 3, 外形1 = 18, x = 18, y = 232 },
    { 路径 = '4.tga', 外形 = 4, 外形1 = 18, x = 92, y = 64 },
    { 路径 = '5.tga', 外形 = 5, 外形1 = 18, x = 92, y = 148 },
    { 路径 = '6.tga', 外形 = 6, 外形1 = 18, x = 92, y = 232 },
    { 路径 = '7.tga', 外形 = 7, 外形1 = 18, x = 177, y = 64 },
    { 路径 = '8.tga', 外形 = 8, 外形1 = 18, x = 177, y = 148 },
    { 路径 = '9.tga', 外形 = 9, 外形1 = 18, x = 177, y = 232 },
    { 路径 = '10.tga', 外形 = 10, 外形1 = 18, x = 251, y = 64 },
    { 路径 = '11.tga', 外形 = 11, 外形1 = 18, x = 251, y = 148 },
    { 路径 = '12.tga', 外形 = 12, 外形1 = 18, x = 251, y = 232 },
    { 路径 = '13.tga', 外形 = 13, 外形1 = 18, x = 336, y = 64 },
    { 路径 = '14.tga', 外形 = 14, 外形1 = 18, x = 336, y = 148 },
    { 路径 = '15.tga', 外形 = 15, 外形1 = 18, x = 336, y = 232 },
    { 路径 = '16.tga', 外形 = 16, 外形1 = 18, x = 410, y = 64 },
    { 路径 = '17.tga', 外形 = 17, 外形1 = 18, x = 410, y = 148 },
    { 路径 = '18.tga', 外形 = 18, 外形1 = 18, x = 410, y = 232 },

    { 路径 = '60.tga', 外形 = 60, 外形1 = 6, x = 495, y = 64 },
    { 路径 = '61.tga', 外形 = 61, 外形1 = 6, x = 495, y = 148 },
    { 路径 = '62.tga', 外形 = 62, 外形1 = 6, x = 495, y = 232 },
    { 路径 = '63.tga', 外形 = 63, 外形1 = 6, x = 569, y = 64 },
    { 路径 = '64.tga', 外形 = 64, 外形1 = 6, x = 569, y = 148 },
    { 路径 = '65.tga', 外形 = 65, 外形1 = 6, x = 569, y = 232 }
} do
    ...
    function 按钮:初始化()
        self:置正常精灵(
            生成精灵(
                ...
                68,
                function()
                    __res:getsf('photo/facebig/%s', v.路径):置拉伸(52, 68):显示(0, 0)
                end
            )
        )
        self:置按下精灵(
            生成精灵(
                ...
                68,
                function()
                    __res:getsf('photo/facebig/%s', v.路径):置拉伸(52, 68):显示(1, 1)
                end
            )
        )
    end
    ...
    function 按钮:左键弹起()
        ...
        角色创建.动画2 = require('对象/基类/动作') { 外形 = v.外形 + v.外形1, 模型 = 'guard' }
        角色创建:刷新介绍()
    end
end
