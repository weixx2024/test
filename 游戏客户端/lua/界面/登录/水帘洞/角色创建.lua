...
function 角色创建:初始化()
    ...
    self:置精灵(__res:getspr('gires2/dialog/createrole.tcp'))
    self.选中框 = __res:getspr('gires2/login/selectrole.tca')
    self.选中坐标 = { x = 113, y = 25 }
    self.选中 = 1
    self.动画 = require('对象/基类/动作') { 外形 = 1, 模型 = 'guard' }
    self.动画2 = require('对象/基类/动作') { 外形 = 1, 模型 = 'guard' }
    self.rwlb = {
...
角色创建:创建文本('提示文本', 240, 330, 270, 105):置文字(__res.F13):置文本(
'逍遥生\n【种族】人【性别】男\n【武器】扇或剑\n一袭白衫一把铁扇或一柄长剑,凭此三物而走遍江湖。与一般武夫不同的是,他们在快意恩仇之余,也喜欢舞文弄墨。')
function 角色创建:刷新介绍()
...
--===============================================================================================
for i, v in ipairs {
    { 路径 = '1.png', 外形 = 1, x = 113, y = 25 },
    { 路径 = '2.png', 外形 = 2, x = 198, y = 25 },
    { 路径 = '3.png', 外形 = 3, x = 283, y = 25 },
    { 路径 = '4.png', 外形 = 4, x = 368, y = 25 },
    { 路径 = '5.png', 外形 = 5, x = 453, y = 25 },
    { 路径 = '6.png', 外形 = 6, x = 538, y = 25 },
    { 路径 = '7.png', 外形 = 7, x = 113, y = 122 },
    { 路径 = '8.png', 外形 = 8, x = 198, y = 122 },
    { 路径 = '9.png', 外形 = 9, x = 283, y = 122 },
    { 路径 = '10.png', 外形 = 10, x = 368, y = 122 },
    { 路径 = '11.png', 外形 = 11, x = 453, y = 122 },
    { 路径 = '12.png', 外形 = 12, x = 538, y = 122 },
    { 路径 = '13.png', 外形 = 13, x = 113, y = 220 },
    { 路径 = '14.png', 外形 = 14, x = 198, y = 220 },
    { 路径 = '15.png', 外形 = 15, x = 283, y = 220 },
    { 路径 = '16.png', 外形 = 16, x = 368, y = 220 },
    { 路径 = '17.png', 外形 = 17, x = 453, y = 220 },
    { 路径 = '18.png', 外形 = 18, x = 538, y = 220 }
} do
    ...
    function 按钮:左键弹起()
        ...
        if i > 18 then
            角色创建.动画2 = require('对象/基类/动作') { 外形 = v.外形 + 6, 模型 = 'guard' }
        else
...
local 角色名称 = 角色创建:创建文本输入('角色名称', 345, 438, 110, 16)
...
local 骰子按钮 = 角色创建:创建按钮('骰子按钮', 470, 432)
function 骰子按钮:初始化()
    self:设置按钮精灵('gires3/other/骰子.tcp')
end
...
local 创建按钮 = 角色创建:创建按钮('角色创建按钮', 525, 340)
function 创建按钮:初始化()
...
local 取消按钮 = 角色创建:创建按钮('取消按钮', 525, 382)
function 取消按钮:初始化()
...
local 离开按钮 = 角色创建:创建按钮('离开按钮', 525, 424)
function 离开按钮:初始化()
